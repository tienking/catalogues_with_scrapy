...
HISTORY_PATH = "./one_cata/download_history.json"
CATALOGUE_INFO_PATH = abspath("./one_cata/images_info/")
CATALOGUE_PATH = abspath("./one_cata/images/")
WEB_PAGES_PATH = "./one_cata/one_cata.csv"
